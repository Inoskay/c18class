...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(350, width-50),40, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(350, width-50),40, 10, 10));
...
function createjewelry() {
  ...
  var jewelry = createSprite(Math.round(random(350, width-50),40, 10, 10));
...
function createSword(){
  ...
  var sword = createSprite(Math.round(random(350, width-50),40, 10, 10));
